/* ../ARPACK/SRC/cnapps.f -- translated by f2c (version 20100827).
	...
	resid, complex *q, integer *ldq, complex *workl, complex *workd)
{
    ...
    /* Local variables */
    ARPACK_TLS real c__;
    ARPACK_TLS complex f, g;
    ARPACK_TLS integer i__, j;
    ARPACK_TLS complex r__, s, t;
    ARPACK_TLS real t0, t1;
    ARPACK_TLS complex h11, h21;
