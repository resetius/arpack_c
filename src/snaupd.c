/* ../ARPACK/SRC/snaupd.f -- translated by f2c (version 20100827).
	...
	which_len)
{
    ...
    ARPACK_TLS integer nb, ih, iq, np, iw, ldh, ldq, nev0, mode, ierr, iupd, next,
	     ritzi;
    ...
    ARPACK_TLS integer bounds, ishift, msglvl, mxiter;
